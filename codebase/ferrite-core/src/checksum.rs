...
/// ## KNOWN ASYMMETRY
///
/// MAIN LOOP PROCESSES CHUNKS IN LITTLE-ENDIAN ORDER.
/// REMAINDER BYTES ARE PROCESSED IN REVERSE (MSB-FIRST).
/// THIS ASYMMETRY MEANS BYTE SWAPS WITHIN A 4-BYTE CHUNK
/// ARE DETECTED, BUT BYTE REORDERING ACROSS CHUNK BOUNDARIES
/// MAY PRODUCE COLLISIONS.
///
/// FOR PRODUCTION SEU DETECTION, USE `Crc32`.
pub struct XorFold;
